# Note : The program allow to facilitate the champion selection
# It ables you  to identify the champion you need per Position of the rift, their ability and their Attribute
# First you need to enter you summoner Name and your API Key in the variable SummonerName and APIKey
# When you launch the program it will ask you to choose different things to identify the champion you need.
...
#********************   CONNECTION TO API      **************
def requestsSummonerData(region, summonerName, APIKey):
        URL='https://' + region + '.api.riotgames.com/lol/summoner/v4/summoners/by-name/'+summonerName+'?api_key='+APIKey
        response = requests.get(URL)
        return response.json()

region = 'euw1'
summonerName='Lenayas07'
APIKey ='RGAPI-3097dc7c-e5d8-4e17-b6bf-4dfae95da0c9' #see https://developer.riotgames.com/ if you need API Key
responseJSON=requestsSummonerData(region,summonerName, APIKey)
